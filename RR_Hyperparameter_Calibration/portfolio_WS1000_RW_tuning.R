...
load(paste0("rho_Dantzig_portfolio_WS",window_size,"_20250125.RData"))
rho1=rho$rho1
rho2=rho$rho2
rho3=rho$rho3

load(paste0("glasso_rho_portfolio_parameter_WS",window_size,"_20250117.RData"))
rho_glasso=glasso_rho_portfolio_parameter$rho
...
for(t in 1: length(W_in)){
  alpha=(sum(rho2[[t]])*sum(rho1[[t]])*mean(ER_in[[t]])-(sum(rho2[[t]]))^2)/(ER_in[[(t)]]%*%rho2[[t]]*sum(rho1[[t]])-(sum(rho2[[t]]))^2)
  w[[(t)]] = alpha*rho2[[t]]/sum(rho2[[t]])+(1-alpha)*rho1[[t]]/sum(rho1[[t]])
  aus<-as.matrix(repmat(w[[(t)]],22,1)*W_out[[t]])
...
for(t in 1: length(W_in)){
  ## compute global minimum variance portfolio without short ##
  if(c(rho1[[t]]/sum(rho1[[t]]))%*%c(EC_DS[[(t)]])>mean(EC_DS[[t]])){
    alpha=(sum(rho3[[t]])*sum(rho1[[t]])*mean(EC_DS[[t]])-(sum(rho3[[t]]))^2)/(EC_DS[[(t)]]%*%rho3[[t]]*sum(rho1[[t]])-(sum(rho3[[t]]))^2)
    w[[(t)]] = c(alpha)*rho3[[t]]/sum(rho3[[t]])+(1-c(alpha))*rho1[[t]]/sum(rho1[[t]])
  }
  else{
    w[[(t)]] = rho1[[t]]/sum(rho1[[t]])
  }
...
for (i in 1:length(quantl)) {
  ...
  cumureturn_temporal<-list()
  for(t in 1: length(W_in)){
    if((c(rho1[[t]]/sum(rho1[[t]]))%*%c(EC_DS[[(t)]]))>quantile(EC_DS[[(t)]],quantl[i])){
      alpha=c((sum(rho3[[t]])*sum(rho1[[t]])*quantile(EC_DS[[(t)]],quantl[i])-(sum(rho3[[t]]))^2)/(EC_DS[[(t)]]%*%rho3[[t]]*sum(rho1[[t]])-(sum(rho3[[t]]))^2))
      w[[(t)]] = alpha*rho3[[t]]/sum(rho3[[t]])+(1-alpha)*rho1[[t]]/sum(rho1[[t]])
    }
    else{
      w[[(t)]] = rho1[[t]]/sum(rho1[[t]])
    }
...
for(t in 1: length(W_in)){
  ## compute global minimum variance portfolio ##
  if(c(rho1[[t]]/sum(rho1[[t]]))%*%c(EC_DS[[(t)]])>phi_star[[t]]){
    alpha=c((sum(rho3[[t]])*sum(rho1[[t]])*phi_star[[t]]-(sum(rho3[[t]]))^2)/(EC_DS[[(t)]]%*%rho3[[t]]*sum(rho1[[t]])-(sum(rho3[[t]]))^2))
    w[[(t)]] = alpha*rho3[[t]]/sum(rho3[[t]])+(1-alpha)*rho1[[t]]/sum(rho1[[t]])
  }
  else{
    w[[(t)]] = rho1[[t]]/sum(rho1[[t]])
...
for(t in 1: length(W_in)){
  ## compute 3 constraint network portfolio ##
  if(c(rho1[[t]]/sum(rho1[[t]]))%*%c(EC_DS[[(t)]])>mean(EC_DS[[t]])){
    if(c(rho1[[t]]/sum(rho1[[t]]))%*%c(ER_in[[(t)]])<mean(ER_in[[t]])){
      # 3 constraint case
      M1 <- cbind(rbind(1,mean(EC_DS[[(t)]]),mean(ER_in[[(t)]])),
                  rbind(sum(rho3[[(t)]]),EC_DS[[(t)]]%*%rho3[[(t)]],ER_in[[(t)]]%*%rho3[[(t)]]),
                  rbind(sum(rho2[[(t)]]),EC_DS[[(t)]]%*%rho2[[(t)]],ER_in[[(t)]]%*%rho2[[(t)]]))
      M2 <- cbind(rbind(sum(rho1[[(t)]]),EC_DS[[(t)]]%*%rho1[[(t)]],ER_in[[(t)]]%*%rho1[[(t)]]),
                  rbind(1,mean(EC_DS[[(t)]]),mean(ER_in[[(t)]])),
                  rbind(sum(rho2[[(t)]]),EC_DS[[(t)]]%*%rho2[[(t)]],ER_in[[(t)]]%*%rho2[[(t)]]))
      M <- cbind(rbind(sum(rho1[[(t)]]),EC_DS[[(t)]]%*%rho1[[(t)]],ER_in[[(t)]]%*%rho1[[(t)]]),
                 rbind(sum(rho3[[(t)]]),EC_DS[[(t)]]%*%rho3[[(t)]],ER_in[[(t)]]%*%rho3[[(t)]]),
                 rbind(sum(rho2[[(t)]]),EC_DS[[(t)]]%*%rho2[[(t)]],ER_in[[(t)]]%*%rho2[[(t)]]))
      gamma1 <- det(M1)/det(M)
      gamma2 <- det(M2)/det(M)
      alpha1 <- c(gamma1*sum(rho3[[t]]))
      alpha2 <- c(gamma2*sum(rho2[[t]]))
      w1 <- (1-alpha1-alpha2)*rho1[[t]]/sum(rho1[[t]])
      w2 <- alpha1*rho3[[t]]/sum(rho3[[t]])
      w3 <- alpha2*rho2[[t]]/sum(rho2[[t]])
      w[[(t)]] = w1 +  w2 + w3
    }
    else{
    ...
    if(c(rho1[[t]]/sum(rho1[[t]]))%*%c(ER_in[[(t)]])<mean(ER_in[[t]])){
      ...
      alpha=c((sum(rho2[[t]])*sum(rho1[[t]])*mean(ER_in[[t]])-(sum(rho2[[t]]))^2)/(ER_in[[(t)]]%*%rho2[[t]]*sum(rho1[[t]])-(sum(rho2[[t]]))^2))
      w[[(t)]] = alpha*rho2[[t]]/sum(rho2[[t]])+(1-alpha)*rho1[[t]]/sum(rho1[[t]])
    }
    else{
  ...
  if(c(row_sums(glasso.icov)/sum(glasso.icov))%*%c(EC_DS[[(t)]])>mean(EC_DS[[t]])){
    if(c(row_sums(glasso.icov)/sum(glasso.icov))%*%c(ER_in[[(t)]])<mean(ER_in[[t]])){
      ...
      M2 <- cbind(rbind(sum(glasso.icov),EC_DS[[(t)]]%*%row_sums(glasso.icov),ER_in[[(t)]]%*%row_sums(glasso.icov)),
                  rbind(1,mean(EC_DS[[(t)]]),mean(ER_in[[(t)]])),
                  rbind(sum(glasso.icov%*%ER_in[[(t)]]),EC_DS[[(t)]]%*%glasso.icov%*%ER_in[[(t)]],ER_in[[(t)]]%*%glasso.icov%*%ER_in[[(t)]]))
      M <- cbind(rbind(sum(glasso.icov),EC_DS[[(t)]]%*%rho1[[(t)]],ER_in[[(t)]]%*%rho1[[(t)]]),
                 rbind(sum(glasso.icov%*%EC_DS[[(t)]]),EC_DS[[(t)]]%*%glasso.icov%*%EC_DS[[(t)]],ER_in[[(t)]]%*%glasso.icov%*%EC_DS[[(t)]]),
                 rbind(sum(glasso.icov%*%ER_in[[(t)]]),EC_DS[[(t)]]%*%glasso.icov%*%ER_in[[(t)]],ER_in[[(t)]]%*%glasso.icov%*%ER_in[[(t)]]))
      gamma1 <- det(M1)/det(M)
      gamma2 <- det(M2)/det(M)
...
for(t in 1: length(W_in)){
  ## compute global minimum variance portfolio ##
  if((c(rho1[[t]]/sum(rho1[[t]]))%*%c(EC_DS[[(t)]]))>phi_star[[t]]){
    if((c(rho1[[t]]/sum(rho1[[t]]))%*%c(ER_in[[(t)]]))<phi_star[[t]]){
      # 3 constraint case
    ...
    if(((rho1[[t]]/sum(rho1[[t]]))%*%ER_in[[(t)]])<mean(ER_in[[t]])){
      # 1 expected return constraint case 
      alpha=c((sum(rho2[[t]])*sum(rho1[[t]])*mean(ER_in[[t]])-(sum(rho2[[t]]))^2)/(ER_in[[(t)]]%*%rho2[[t]]*sum(rho1[[t]])-(sum(rho2[[t]]))^2))
      w[[(t)]] = alpha*rho2[[t]]/sum(rho2[[t]])+(1-alpha)*rho1[[t]]/sum(rho1[[t]])
    }
...
save(Portfolio.Scenario,file="Portfolios_WS1000_RW_20250125.RData")
