...
# Load eigenvector centrality Dantzig estimation rolling window tuned hyperparameter #####
# This rolling window tuning process is produced in "rolling_window_change_window_size_Dantzig_lambda_eigenvector_centrality_windowsize750.R"
load("~/Documents/GitHub/Network-Portfolio/RR_Hyperparameter_Calibration/Dantzig_lambda_rolling_window_windowsize750.RData")
...
for (t in 1: T.windows) {
  ...
  lmd.EC.Dantzig.WS750=lmd.EC.Dantzig.list[[t]] 
...
save(eigenvector_centrality,file = "eigenvector_centrality_WS750_20241227.RData")
...
# These hyper parameters are selected in "rolling_window_hyperparameter_tuning_125_250_375_500.R"
# Do not be confused by the name, it actually covers window size 750, 1000
lmd1.WS750=0.3592
...
theta<-list("theta1"=theta1,
            "theta2"=theta2,
            "theta3"=theta3)
save(theta,file="theta_Dantzig_WS750_20241227.RData")
load("theta_Dantzig_WS750_20241227.RData")
theta1=theta$theta1
theta2=theta$theta2
theta3=theta$theta3
...
save(Portfolio.Scenario,file="Portfolios_WS750_20241227.RData")
