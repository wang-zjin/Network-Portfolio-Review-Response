...
# lmd.EC.Dantzig <- mean(unlist(lmd.EC.Dantzig.list))
# 
...
# save(eigenvector_centrality,file = "eigenvector_centrality_rollingwindow_median_20250125.RData")

load("eigenvector_centrality_rollingwindow_median_20250125.RData")
...
#             "theta2"=theta2,
#             "theta3"=theta3)
# save(theta,file="theta_Dantzig_20250125.RData")
load("theta_Dantzig_20250125.RData")
theta1=theta$theta1
theta2=theta$theta2
theta3=theta$theta3
...
save(Portfolio.Scenario,file="Portfolios_WS500_RW_median_20250125.RData")
