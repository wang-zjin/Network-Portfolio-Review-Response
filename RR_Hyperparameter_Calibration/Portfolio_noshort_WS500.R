...
##### Load portfolios #####
load("Portfolios_WS500_20240723.RData")
...
# compare GMV, MV, EW, 2-constraint: Plug-In network, Dantzig network and glasso network #####
...
xtable(rbind(cbind(cumureturn_network_2constraint_noshort[n]/n*252*100,
                   cumureturn_network_3constraint_noshort[n]/n*252*100),
             cbind(std(return_network_2constraint_noshort)*sqrt(252)*100,
                   std(return_network_3constraint_noshort)*sqrt(252)*100),
             cbind(cumureturn_network_2constraint_noshort[n]/n*252/(std(return_network_2constraint_noshort)*sqrt(252))*100,
                   cumureturn_network_3constraint_noshort[n]/n*252/(std(return_network_3constraint_noshort)*sqrt(252))*100),
             cbind(maxDrawdown(return_network_2constraint_noshort-1),
                   maxDrawdown(return_network_3constraint_noshort-1)),
             cbind(p_turnover(w_network_2constraint_noshort),
                   p_turnover(w_network_3constraint_noshort))
),digits = 2)

xtable(rbind(cbind(cumureturn_network_vary_with_phi_noshort[[1]][n]/n*252*100,
                   cumureturn_network_vary_with_phi_3constraint_noshort[[1]][n]/n*252*100),
             cbind(std(return_network_vary_with_phi_noshort[[1]])*sqrt(252)*100,
                   std(return_network_vary_with_phi_3constraint_noshort[[1]])*sqrt(252)*100),
             cbind(cumureturn_network_vary_with_phi_noshort[[1]][n]/n*252/(std(return_network_vary_with_phi_noshort[[1]])*sqrt(252))*100,
                   cumureturn_network_vary_with_phi_3constraint_noshort[[1]][n]/n*252/(std(return_network_vary_with_phi_3constraint_noshort[[1]])*sqrt(252))*100),
             cbind(maxDrawdown(return_network_vary_with_phi_noshort[[1]]-1),
                   maxDrawdown(return_network_vary_with_phi_3constraint_noshort[[1]]-1)),
             cbind(p_turnover(w_network_vary_with_phi_noshort[[1]]),
                   p_turnover(w_network_vary_with_phi_3constraint_noshort[[1]]))
),digits = 2)
