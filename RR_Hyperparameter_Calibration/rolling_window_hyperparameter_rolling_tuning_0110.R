...
save(lmd.EC.Dantzig.list, file="Dantzig_lambda_rolling_window_windowsize500.RData")

load("~/Documents/GitHub/Network-Portfolio/RR_Hyperparameter_Calibration/Dantzig_lambda_rolling_window_windowsize500.RData")
...
for (t in 1: length(W_in)) {
  ...
  lmd.EC.Dantzig.WS500=lmd.EC.Dantzig.list[[t]] # the first element is 0.682
...
save(eigenvector_centrality,file = "eigenvector_centrality_WS500_20241227.RData")
...
T.windows<-length(W)
load("eigenvector_centrality_WS500_20241227.RData")
...
theta<-list("theta1"=theta1,
            "theta2"=theta2,
            "theta3"=theta3)
save(theta,file="theta_Dantzig_WS500_20241227.RData")
load("theta_Dantzig_WS500_20241227.RData")
theta1=theta$theta1
theta2=theta$theta2
theta3=theta$theta3
...
save(Portfolio.Scenario,file="Portfolios_20241227.RData")
